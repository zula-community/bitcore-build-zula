...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-zula/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-zula -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-zula -o bitcore-lib-zula.js';
    }
